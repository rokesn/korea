...
import { getCollection, SITE_URL, COLLECTIONS } from "@/lib/site";
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:title", content: `${c.keyword} 최신 주소 및 링크모음` },
        { property: "og:description", content: c.metaDescription },
        { property: "og:url", content: url },
        { property: "og:type", content: "article" },
        { property: "og:locale", content: "ko_KR" },
        { name: "twitter:title", content: `${c.keyword} 최신 주소 및 링크모음` },
    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-1 mx-auto max-w-3xl w-full px-4 py-12">
        ...
        <section className="mt-8">
          <h2 className="font-display text-2xl font-bold mb-1">{c.keyword}란?</h2>
        ...
        <section className="mt-10">
          <h2 className="font-display text-2xl font-bold mb-4">{c.keyword} 최신 주소 모음</h2>
            ...
            {c.links.map((link) => (
              <li key={link.url}>
                ...
                >
                  ...
                  <ExternalLink size={16} className="shrink-0 text-muted-foreground group-hover:text-primary transition" />
                </a>
              </li>
            ))}
          </ul>
        ...
        <section className="mt-12">
          <h2 className="font-display text-2xl font-bold mb-4">{c.howTo.name}</h2>
        ...
        <section className="mt-12">
          <h2 className="font-display text-2xl font-bold mb-4">자주 묻는 질문 (FAQ)</h2>
        ...
        {related.length > 0 && (
          <section className="mt-12">
            <h2 className="font-display text-2xl font-bold mb-4">관련 링크모음</h2>
            <div className="grid gap-3 sm:grid-cols-2">
              {related.map((rel) => (
                ...
                >
                  ...
                  <ArrowUpRight size={16} className="shrink-0 text-muted-foreground group-hover:text-primary transition" />
                </Link>
              ))}
            </div>
          </section>
